...
const detectTriangle = (a, b, c) => {
  ...
  try {
    ...
    } else if (error instanceof validateNumberInput){
...
console.log(detectTriangle(2, 4, 5)); // segitiga sembarang
console.log(detectTriangle(4, 4, 4)); // segitiga sama sisi
console.log(detectTriangle(5, 5, 2)); // segitiga sama kaki
console.log(detectTriangle(2, 4, "string")); // Invalid input : Argumen ketiga harus number